  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full pb-20">
        {view === 'dashboard' ? <Dashboard /> : <Inventory />}
      </main>

      {/* Mobile Bottom Nav */}
      <div className="sm:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-800 flex justify-around p-2">
         <Button 
